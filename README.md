...
└── doc                                              #各種資料をまとめたディレクトリ
    ├── belongings-list.md                           #持ち物リスト（1配信時）
    ├── belongings-list-two.md                       #持ち物リスト（2配信時）
    ├── live-stream-system-diagram.drawio.svg        #ライブ配信系統図（1配信時）
    └── live-stream-system-diagram-two.drawio.svg    #ライブ配信系統図（2配信時）
```